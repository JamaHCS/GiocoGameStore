...
create database if not exists gioco;
...
INSERT INTO `brand` VALUES (1,'Microsoft','Xbox'),(2,'Sony','PlayStation'),(3,'Nintendo','Nintendo'),(4,'Funko','Funko'),(5,'Generico','Generico');
...
INSERT INTO `category` VALUES (1,'Videojuegos'),(2,'Consolas'),(3,'Souvenirs'),(4,'accesorios');
...
INSERT INTO `client` VALUES (-1,'','','','','0000-00-00','0000-00-00','',0.00,0,0,'','','','','',''),(0,'Administrador','','','','0000-00-00','0000-00-00','',0.00,0,0,'','','','','',''),(1,'Héctor','Jama','Escobedo','Olguín','2019-09-06','2000-03-20','EOOH000320HHGSLCA9',0.00,5,860,'Belén','EOOH000320CJ5','jamahcs@outlook.com','76148',NULL,'7731598533'),(2,'Alan','Martín','Resendiz','Colindres','2019-09-06','1999-10-26','AAAAAAAAAAAAAAAAAA',0.00,1,1,'Pie de la cuesta','AAAAAAAAAAAAAAAA','alan@gmail.com','76148',NULL,'4191173458'),(3,'Andrea',NULL,'Suarez','Mendoza','2020-03-24','2000-07-13',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'4423808805');
...
INSERT INTO `product` VALUES (1,1000,1400,10,'Xbox One','Acción, FPS','M - Mature 17+',1,1,'Halo 5: Guardians'),(2,4000,6000,4,'Xbox One','N/A','N/A',2,1,'Xbox One Slim');
...
INSERT INTO `sale` VALUES (1,1,1,2800,'2020-03-20 12:20:19','Sucursal Antea');
...
INSERT INTO `saleproduct` VALUES (1,1,2,288);
...
INSERT INTO `seller` VALUES (-1,0,'','','','','0','0000-00-00','',NULL,''),(0,0,'Administrador','','','','0','0000-00-00','',NULL,''),(1,1,'Mariana','','Hernandez','Olvera','4424717667','2019-09-05','mariana@gmail.com',NULL,'Sucursal Antea');
...
INSERT INTO `users` VALUES (0,'admin','admin',0,0,0,1),(1,'alanUser','acceso',2,2,-1,1),(2,'JamaHCS','acceso',2,1,-1,1),(3,'marianaUser','acceso',1,-1,1,1),(4,'andreaUser','acceso',2,3,-1,1);
...
-- Dump completed on 2020-03-26 20:31:11
