...
(
  `idClient` int
(5) NOT NULL,
  `firsNameClient` varchar
(20) DEFAULT NULL,
  `secondNameClient` varchar
(20) DEFAULT NULL,
  `middleNameClient` varchar
(20) DEFAULT NULL,
  `lastNameClient` varchar
(20) DEFAULT NULL,
  `phoneNumberClient` varchar
(15) DEFAULT NULL,
...
(18) DEFAULT NULL,
  `pointsClient` float
(2,2) DEFAULT NULL,
  `interiorNumberClient` int
(6) DEFAULT NULL,
  `exteriorNumberClient` int
(6) DEFAULT NULL,
  `streetClient` varchar
(40) DEFAULT NULL,
  `rfcClient` varchar
(16) DEFAULT NULL,
  `emailClient` varchar
(40) DEFAULT NULL,
  `postalCodeClient` varchar
(10) DEFAULT NULL,
  PRIMARY KEY
(`idClient`),
  UNIQUE KEY `idClient`
...
client`
VALUES
  (-1, 'default', '', '', '', '0', '2019-09-05', '1995-10-10', '', 0.00, 0, 0, '', '', '', ''),
  (0, 'Administrador', '', '', '', '0', '2019-09-05', '1995-10-10', '', 0.00, 0, 0, '', '', '', ''),
  (1, 'Héctor', 'Jama', 'Escobedo', 'Olguín', '7731598533', '2019-09-06', '2000-03-20', 'EOOH000320HHGSLCA9', 0.00, 5, 860, 'Belén', 'EOOH000320CJ5', 'jamahcs@outlook.com', '76148'),
  (2, 'Alan', 'Martín', 'Resendiz', 'Colindres', '4191173458', '2019-09-06', '1999-10-26', 'AAAAAAAAAAAAAAAAAA', 0.00, 1, 1, 'Pie de la cuesta', 'AAAAAAAAAAAAAAAA', 'alan@gmail.com', '76148');
...
(20) DEFAULT NULL,
  ...
  `stockProduct` int
(4) DEFAULT NULL,
  `generationProduct` varchar
(20) DEFAULT NULL,
  `clasificationProduct` varchar
(50) DEFAULT NULL,
  `esrb` varchar
(20) DEFAULT NULL,
  `idCategory` int
...
product`
VALUES
  (1, 'Halo 5: Guardians', 1000, 1400, 10, 'Xbox One', 'Acción, FPS', 'M - Mature 17+', 1, 1),
...
sale`
VALUES
  (1, 'Sucursal Antea', '2020-03-20 12:20:19', 2800, 1, 1);
...
(5) NOT NULL,
  `idSupervisor` int
(5) DEFAULT NULL,
  `branchSeller` varchar
(20) DEFAULT NULL,
  `firsNameSeller` varchar
(20) DEFAULT NULL,
  `secondNameSeller` varchar
(20) DEFAULT NULL,
  `middleNameSeller` varchar
(20) DEFAULT NULL,
  `lastNameSeller` varchar
(20) DEFAULT NULL,
  `phoneNumberSeller` varchar
(15) DEFAULT NULL,
