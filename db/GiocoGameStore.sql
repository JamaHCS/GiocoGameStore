CREATE DATABASE  IF NOT EXISTS `gioco` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `gioco`;
...
INSERT INTO `client` VALUES (-1,'default','','','','0','2019-09-05','1995-10-10','',0.00,0,0,'','','',''),(0,'Administrador','','','','0','2019-09-05','1995-10-10','',0.00,0,0,'','','',''),(1,'Héctor','Jama','Escobedo','Olguín','7731598533','2019-09-06','2000-03-20','EOOH000320HHGSLCA9',0.00,5,860,'Belén','EOOH000320CJ5','jamahcs@outlook.com','76148'),(2,'Alan','Martín','Resendiz','Colindres','4191173458','2019-09-06','1999-10-26','AAAAAAAAAAAAAAAAAA',0.00,1,1,'Pie de la cuesta','AAAAAAAAAAAAAAAA','alan@gmail.com','76148');
...
INSERT INTO `seller` VALUES (-1,0,'','default','','','','0','0000-00-00',''),(0,0,'','Administrador','','','','0','0000-00-00',''),(1,1,'Sucursal Antea','Mariana','','Hernandez','Olvera','4424717667','2019-09-05','mariana@gmail.com');
...
INSERT INTO `users` VALUES ('admin','admin',0,-1,-1,NULL),('alanUser','acceso',2,2,-1,NULL),('JamaHCS','acceso',2,1,-1,NULL),('marianaUser','acceso',1,-1,1,NULL);
