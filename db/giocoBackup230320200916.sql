...
/*!40000 ALTER TABLE `client`
    DISABLE KEYS */;
INSERT INTO `client`
VALUES (-1, 'default', '', '', '', '0', '2019-09-05', '1995-10-10', '', 0.00, 0, 0, '', '', '', '', NULL),
       (0, 'Administrador', '', '', '', '0', '2019-09-05', '1995-10-10', '', 0.00, 0, 0, '', '', '', '', NULL),
       (1, 'Héctor', 'Jama', 'Escobedo', 'Olguín', '7731598533', '2019-09-06', '2000-03-20', 'EOOH000320HHGSLCA9', 0.00,
        5, 860, 'Belén', 'EOOH000320CJ5', 'jamahcs@outlook.com', '76148', NULL),
       (2, 'Alan', 'Martín', 'Resendiz', 'Colindres', '4191173458', '2019-09-06', '1999-10-26', 'AAAAAAAAAAAAAAAAAA',
        0.00, 1, 1, 'Pie de la cuesta', 'AAAAAAAAAAAAAAAA', 'alan@gmail.com', '76148', NULL);
/*!40000 ALTER TABLE `client`
    ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `seller`
    DISABLE KEYS */;
INSERT INTO `seller`
VALUES (-1, 0, '', 'default', '', '', '', '0', '0000-00-00', '', NULL),
...
/*!40000 ALTER TABLE `users`
    DISABLE KEYS */;
INSERT INTO `users`
VALUES ('admin', 0, -1, -1, NULL, 'admin', NULL),
       ('acceso', 2, 2, -1, NULL, 'alanUser', NULL),
       ('acceso', 2, 1, -1, NULL, 'JamaHCS', NULL),
       ('acceso', 1, -1, 1, NULL, 'marianaUser', NULL);
/*!40000 ALTER TABLE `users`
    ENABLE KEYS */;
UNLOCK TABLES;
