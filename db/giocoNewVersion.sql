...
VALUES ('', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', -1),
       ('Administrador', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0),
       ('Héctor', 'Jama', 'Escobedo', 'Olguín', '7731598533', '2019-09-06', '2000-03-20', 'EOOH000320HHGSLCA9', 0.00, 5,
        860, 'Belén', 'EOOH000320CJ5', 'jamahcs@outlook.com', '76148', NULL, 1),
       ('Alan', 'Martín', 'Resendiz', 'Colindres', '4191173458', '2019-09-06', '1999-10-26', 'AAAAAAAAAAAAAAAAAA', 0.00,
        1, 1, 'Pie de la cuesta', 'AAAAAAAAAAAAAAAA', 'alan@gmail.com', '76148', NULL, 2);
/*!40000 ALTER TABLE `client`
    ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `product`
    DISABLE KEYS */;
INSERT INTO `product`
VALUES ('Halo 5: Guardians', 1000, 1400, 10, 'Xbox One', 'Acción, FPS', 'M - Mature 17+', 1, 1, 1),
       ('Xbox One Slim', 4000, 6000, 4, 'Xbox One', 'N/A', 'N/A', 2, 1, 2);
/*!40000 ALTER TABLE `product`
    ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `sale`
    DISABLE KEYS */;
INSERT INTO `sale`
VALUES ('Sucursal Antea', '2020-03-20 12:20:19', 2800, 1, 1, 1);
/*!40000 ALTER TABLE `sale`
    ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `seller`
    DISABLE KEYS */;
INSERT INTO `seller`
VALUES (0, '', '', '', '', '', '0', '0000-00-00', '', NULL, -1),
       (0, '', 'Administrador', '', '', '', '0', '0000-00-00', '', NULL, 0),
       (1, 'Sucursal Antea', 'Mariana', '', 'Hernandez', 'Olvera', '4424717667', '2019-09-05', 'mariana@gmail.com',
        NULL, 1);
/*!40000 ALTER TABLE `seller`
    ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `users`
    DISABLE KEYS */;
INSERT INTO `users`
VALUES ('admin', 'admin', 0, 0, 0, 1, 0),
       ('alanUser', 'acceso', 2, 2, -1, 1, 1),
       ('JamaHCS', 'acceso', 2, 1, -1, 1, 2),
       ('marianaUser', 'acceso', 1, -1, 1, 1, 3);
/*!40000 ALTER TABLE `users`
    ENABLE KEYS */;
UNLOCK TABLES;
